...
// DEFINE the global variable (this was missing!)
IWebSocketSignalingClient* signalingClient = nullptr;

// Interface implementation is already in the header, so just the class:
...
public:
	...
	{
		m_webSocket.stop(1000, "Normal closure");  // Use literal values instead of constants
		delete this;
	}
};
...
//// Factory function
//IWebSocketSignalingClient* CreateWebSocketSignalingClient(
...
//	{
//		sprintf(errMsg, "Invalid server URL");
//		return nullptr;
//	}
//
//	if (myID == 0)
//	{
//		sprintf(errMsg, "Invalid user ID");
//		return nullptr;
//	}
//
...
//	}
//
//	signalingClient = new CWebSocketSignalingClient(serverURL, myID);
